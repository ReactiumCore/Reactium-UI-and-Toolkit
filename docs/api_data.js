  ...
  api: [
    {
      ...
      description:
        "<p>Return an Array of capability names granted to the user.</p>",
      parameter: {
        fields: {
          Parameter: [
            {
              ...
              field: "userID",
              description:
                "<p>The Reactium.User id. If empty the User.current id is used.</p>"
            },
            {
              group: "Parameter",
              type: "Boolean",
              ...
              defaultValue: "false",
              description:
                "<p>Fetch capabilities from the server instead of cache.</p>"
            }
          ]
        }
      },
      ...
      filename:
        "reactium_modules/@atomic-reactor/reactium-capability/sdk/index.js",
    ...
    },
    {
      ...
      description:
        "<p>Time in milliseconds that controls when registered capabilities are propagated to the server. If set to <code>false</code>, manually push registered capabilities with <code>Capability.propagate()</code>. Default: <code>10000</code>.</p>",
      filename:
        "reactium_modules/@atomic-reactor/reactium-capability/sdk/index.js",
      groupTitle: "Capability"
    },
    {
      ...
      description:
        "<p>Time in milliseconds that controls how long to cache capability request results. Default: <code>60000</code>.</p>",
      filename:
        "reactium_modules/@atomic-reactor/reactium-capability/sdk/index.js",
      groupTitle: "Capability"
    },
    ...
    },
    {
      ...
      description:
        "<p>Propagate registered capabilities to an Actinium server.</p>",
      parameter: {
        fields: {
          Parameter: [
            {
              ...
              defaultValue: "false",
              description:
                "<p>Execute the propagation regardless of if a current propagation operation is under way. The resolution of the previous propagation operation will be cancelled. If <code>Capability.autosync</code> is <code>true</code>, this function will be called whenever the autosync is initiated.</p>"
            }
          ]
        }
      },
          ...
          Parameter: [
            {
              ...
              field: "id",
              description:
                "<p>String value used when checking for the capability. This function is limited in scope and regularly shouldn't be used. Server-side capability registration is preferred.</p>"
            }
          ]
        }
      },
        ...
        fields: {
          ...
          global: [
            ...
            },
            {
              ...
              field: "serverValue",
              description:
                "<p>optional different value for the server global, useful when value should be used differently on the server code</p>"
            }
          ]
        }
      },
    ...
    },
    {
      ...
      description:
        "<p>On html template responses on server, this hook is called when HTTP headers are added to the response. Both sync and async hook is called.</p>",
      parameter: {
        fields: {
          Parameter: [
            {
              ...
              description:
                "<p>object with key pairs (header name =&gt; header value)</p>"
            },
            {
              group: "Parameter",
              type: "Object",
    ...
    },
    {
      ...
      description:
        "<p>Called on server-side during service-worker-allowed middleware. Used to define the HTTP response header &quot;Service-Worker-Allowed&quot;. By default, this header will allow the document root, &quot;/&quot;. Both sync and async version called.</p>",
      parameter: {
        fields: {
          Parameter: [
            {
              ...
              description:
                "<p>with property 'Service-Worker-Allowed' (case sensitive) and its value.</p>"
            },
            {
              group: "Parameter",
              type: "Object",
          ...
          Parameter: [
            {
              ...
              field: "context",
              description:
                "<p>context.appElement MUST be an HTMLElement where your React appliation will bind to the DOM.</p>"
            }
          ],
          appElement: [
            {
              ...
              field: "the",
              description:
                "<p>DOM element to bind to - by default <code>document.getElementById('router')</code>.</p>"
            }
          ]
        }
      },
    ...
    },
    {
      ...
      description:
        "<p>Called during application binding, this minor hook will allow you to change the format of the of the front-end Javascript console message indicating application start. async only - used in front-end application only</p>",
      group: "Hooks",
      version: "0.0.0",
      filename: ".core/app/index.js",
      groupTitle: "Hooks"
    },
    {
      ...
      description:
        '<p>Called after app-bindpoint to define any React context providers, using the <a href="#api-Reactium-Reactium.AppContext">Reactium.AppContext</a> registry.</p>',
      group: "Hooks",
      version: "0.0.0",
      filename: ".core/app/index.js",
      groupTitle: "Hooks"
    },
    {
      ...
      title: "app-ready",
      description:
        "<p>The final hook run after the front-end application has bee bound or hydrated. After this point, the all hooks are runtime hooks.</p>",
      name: "app-ready",
      group: "Hooks",
      version: "0.0.0",
      filename: ".core/app/index.js",
    ...
    },
    {
      ...
      name: "app-router",
      description:
        "<p>Called after app-context-provider to define the registered Router component (i.e. <code>Reactium.Component.register('Router'...)</code>). After this hook, the ReactDOM bindings will actually take place. async only - used in front-end application only</p>",
      group: "Hooks",
      version: "0.0.0",
      filename: ".core/app/index.js",
      groupTitle: "Hooks"
    },
    {
      ...
      description:
        "<p>Called after plugin and routing initialization to define element and dynamic component for one-off component bindings to the DOM. e.g. In development mode, used to render Redux Dev tools. async only - used in front-end application only</p>",
      parameter: {
        fields: {
          Parameter: [
            {
              ...
              field: "context",
              description:
                "<p>context.bindPoints MUST be an array of binding objects after this hook is called</p>"
            }
          ],
          binding: [
            {
              ...
              field: "the",
              description:
                "<p>DOM element to bind to (e.g. document.getElementById('my-element'))</p>"
            },
            {
              group: "binding",
              type: "String",
              ...
              field: "string",
              description:
                "<p>matching a React component module in one of the Reactium built-in webpack contexts (src/app/components or src/app/components/common-ui) e.g. 'DevTools' maps to src/app/components/DevTools</p>"
            }
          ]
        }
      },
    ...
    },
    {
      ...
      description:
        "<p>Called after init to give an application a change to load async dependencies. Many Domain Driven Design (DDD) artifacts from generated src/manifest.js are loaded on this hook async only - used in front-end</p>",
      group: "Hooks",
      version: "0.0.0",
      filename: ".core/app/index.js",
      groupTitle: "Hooks"
    ...
    },
    {
      ...
      name: "init",
      description:
        "<p>Called before all other hooks on Reactium application startup. async only - used in front-end</p>",
      group: "Hooks",
      version: "0.0.0",
      filename: ".core/app/index.js",
      groupTitle: "Hooks"
          ...
          Parameter: [
            {
              ...
              field: "context",
              description:
                "<p>Core attaches generated manifest loaded dependencies to context.deps</p>"
            }
          ]
        }
      },
    ...
    },
    {
      ...
      name: "plugin-ready",
      description:
        "<p>Called after all plugin registration callbacks have completed and routes have loaded.</p>",
      group: "Hooks",
      version: "0.0.0",
      filename: ".core/app/index.js",
      groupTitle: "Hooks"
    },
    {
      ...
      name: "register-route",
      description:
        "<p>Called on boot after routes-init, and during runtime operation of the front-end application, whenever a new route is registered. Can be used to augment a router object before it is registered to the router. async only - used in front-end</p>",
      parameter: {
        fields: {
          Parameter: [
            {
              ...
              field: "route",
              description:
                "<p>the new or updated route, indentified by unique id (route.id)</p>"
            }
          ]
        }
      },
    ...
    },
    {
      ...
      name: "routes-init",
      description:
        "<p>Called after plugin-init, to add React Router routes to Reactium.Routing register before the Router component is initialized and finally the application is bound to the DOM. async only - used in front-end</p>",
      group: "Hooks",
      version: "0.0.0",
      filename: ".core/sdk/routing/index.js",
      groupTitle: "Hooks"
    },
    {
      ...
      name: "sdk-init",
      description:
        "<p>Called after reactium-hooks.js DDD artifacts are loaded, to allow the Reactium SDK singleton to be extended before the init hook.</p>",
      group: "Hooks",
      version: "0.0.0",
      filename: ".core/app/index.js",
      groupTitle: "Hooks"
    },
    {
      ...
      version: "0.0.0",
      filename:
        "reactium_modules/@atomic-reactor/reactium-service-worker/sdk/index.js",
      groupTitle: "Hooks"
    },
    {
      type: "Hook",
      ...
      name: "zone-defaults",
      description:
        "<p>Called after dependencies-load by Reactium.Zone.init() for loading default component rendering Zone controls and components. async only - used in front-end</p>",
      parameter: {
        fields: {
          Parameter: [
            {
    ...
    },
    {
      ...
      version: "1.0.7",
      description:
        "<p>React hook to short hand for addEventListener and removeEventLister for one or more callbacks.</p>",
      parameter: {
        fields: {
          Parameter: [
            {
              ...
              field: "eventTarget",
              description:
                "<p>Some event target object (implementing addEventListener and removeEventLister)</p>"
            },
            {
              group: "Parameter",
              type: "Object",
              ...
              description:
                "<p>Object keys are event names, and Object values are callbacks to be subscribed/unsubscribed.</p>"
            },
            {
              group: "Parameter",
              type: "useEffectDeps",
    ...
    },
    {
      ...
      description:
        "<p>React hook to create a new imperative handle reference, similar to <code>useRegisterHandle()</code> except that it returns a sync state object (see useSyncState) and will cause rerenders in the controlled component.</p>",
      parameter: {
        fields: {
          Parameter: [
            {
      ...
      version: "0.0.0",
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/sync-handle.js",
      groupTitle: "ReactHook"
    },
    {
      type: "ReactHook",
    ...
    },
    {
      ...
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/useScrollToggle.js",
      groupTitle: "ReactHook"
    },
    {
      type: "ReactHook",
      ...
      description:
        "<p>React hook to subscribe to updates to state on an imperative handle created by useRegisterSyncHandle. See useRegisterSyncHandle for full example.</p>",
      parameter: {
        fields: {
          Parameter: [
            {
            ...
            },
            {
              ...
              field: "selector",
              description:
                "<p>object path string or array, or selector function passed the sync state object (see useSyncState); returns seleted state</p>"
            },
            {
              group: "Parameter",
              type: "Mixed",
              ...
              field: "default",
              description:
                "<p>default selected value (if selector is String or Array)</p>"
            }
          ]
        }
      },
    ...
    },
    {
      ...
      title: "useSyncHandle()",
      description:
        "<p>React hook to subscribe to updates for a registered sync handle.</p>",
      parameter: {
        fields: {
          Parameter: [
            {
            ...
            },
            {
              ...
              defaultValue: "set",
              description:
                "<p>Trigger update of the consuming component when EventTarget event of this type is dispatched. Defaults tot 'set'.</p>"
            }
          ]
        }
      },
    ...
    },
    {
        ...
        fields: {
          Parameter: [
            ...
            },
            {
              ...
              defaultValue: "set",
              description:
                "<p>The event name to listen for on the <code>EventTarget</code> object. When the event is dispatched, the hook will update the synced state with the <code>event.detail</code> property, and trigger a rerender of the React component.</p>"
            }
          ]
        }
      },
          ...
          "Success 200": [
            {
              ...
              field: "syncState",
              description:
                "<p>The <code>ReactiumSyncState</code> instance returned by the hook.</p>"
            }
          ]
        }
      },
      version: "0.0.0",
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/useSyncState.js",
      groupTitle: "ReactHook"
    },
    {
      type: "ReactHook",
    ...
    },
    {
        ...
        fields: {
          Parameter: [
            ...
            },
            {
              ...
              defaultValue: "true",
              description:
                "<p>If true, returns the current value of the components in the zone, separate from the reference. Otherwise, returns the ReactiumSyncState object. This can be useful if you wish to use the components value with a non-memoized value.</p>"
            }
          ]
        }
      },
      ...
      version: "0.0.0",
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/named-exports/Zone.js",
      groupTitle: "ReactHook"
    },
    {
      type: "Object",
      ...
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/sdks/cache/index.js",
    ...
    },
    {
      ...
      version: "3.2.1",
      description:
        "<p>Retrieve an enumerated list of capabilities for the specified user.</p>",
      parameter: {
        fields: {
          Parameter: [
            {
            ...
            },
            {
              ...
              field: "userID",
              description:
                "<p>The Actinium.User id value. If empty the current user is used.</p>"
            }
          ]
        }
      },
    ...
    },
    {
      ...
      description:
        "<p>Register a React component to be used with a specific useHookComponent React hook. This must be called before the useHookComponent that defines the hook.</p>",
      parameter: {
        fields: {
          Parameter: [
            {
      ...
      version: "0.0.0",
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/sdks/component/index.js",
    ...
    },
    {
      ...
      version: "0.0.0",
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/sdks/handle/index.js",
    ...
    },
    {
      ...
      version: "0.0.0",
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/sdks/hook/index.js",
    ...
    },
    {
      ...
      version: "0.0.0",
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/sdks/plugin/index.js",
    ...
    },
    {
      ...
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/sdks/prefs/index.js",
    ...
    },
    {
      ...
      version: "0.0.0",
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/sdks/pulse/index.js",
    ...
    },
    {
      ...
      description:
        "<p>Unregister an existing route, by id. Note: You can not unregister the 'NotFound' component. You can only replace it using the registering a NotFound component with Reactium.Component.register().</p>",
      parameter: {
        fields: {
          Parameter: [
            {
    ...
    },
    {
      ...
      version: "0.0.0",
      filename:
        "reactium_modules/@atomic-reactor/reactium-setting/sdk/index.js",
        ...
        fields: {
          Parameter: [
            ...
            },
            {
              ...
              field: "userID",
              description:
                "<p>The Actinium.User id. If empty, the User.current() id is used.</p>"
            }
          ]
        }
      },
    ...
    },
    {
      ...
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/sdks/utils/index.js",
    ...
    },
    {
      ...
      description:
        "<p>If global window object exists, and does not have boolean isJSDOM flag, this context may be browser or electron. Use isElectronWindow() to know the latter.</p>",
      parameter: {
        fields: {
          Parameter: [
            {
    ...
    },
    {
      ...
      name: "isServerWindow",
      description:
        "<p>If global window object exists, and has boolean isJSDOM flag, this context is a JSON window object (not in the browser or electron)</p>",
      parameter: {
        fields: {
          Parameter: [
            {
    ...
    },
    {
      ...
      version: "0.0.0",
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/sdks/zone/index.js",
        ...
        fields: {
          Parameter: [
            ...
            },
            {
              ...
              field: "id",
              description:
                "<p>the id of the registered component, specified in the object passed to Zone.addComponent() or returned by it.</p>"
            }
          ]
        }
      },
    ...
    },
    {
      ...
      description:
        "<p>Get existing registrations for a zone, by default goes through mapping, sorting, filtering. Add raw=true to get unadulterated list, even if they may not be renderable in the Zone. Returns the object used in Zone.addComponent()</p>",
      parameter: {
        fields: {
          Parameter: [
            {
            ...
            },
            {
              ...
              defaultValue: "false",
              description:
                "<p>Set to true to get all components, whether or not they are currently filtered, and without mapping or extra sorting.</p>"
            }
          ]
        }
      },
    ...
    },
    {
      ...
      description:
        "<p>Returns true if component with id is present in the zone.</p>",
      parameter: {
        fields: {
          Parameter: [
            {
    ...
    },
    {
      ...
      description:
        '<p>A Registry used for top-level React wrapping context provider, such as Redux or Theme. See <a href="#api-Reactium-Registry">Registry</a> for full details on Registry methods / properties. Use this to register a React context provider, as well as any properties that are passed to the context.</p>',
      parameter: {
        fields: {
          Parameter: [
            {
              ...
              field: "list",
              description:
                "<p>get list of most recent (or highest order) registered objects, filtering out unregistered or banned objects.</p>"
            },
            {
              group: "Parameter",
              type: "Method",
              ...
              field: "register",
              description:
                "<p><code>reg.register(id,data)</code> pass an identifier and a data object to register the object. The identifier will be added if it is not already registered (but protected) and not banned.</p>"
            },
            {
              group: "Parameter",
              type: "Method",
              ...
              field: "unregister",
              description:
                "<p><code>reg.unregister(id)</code> pass an identifier to unregister an object. When in HISTORY mode (default), previous registration will be retained, but the object will not be listed. In CLEAN mode, the previous registrations will be removed, unless protected.</p>"
            }
          ],
          register: [
            {
          ...
          Provider: [
            {
              ...
              field: "provider",
              description:
                "<p>the context provider. This provider must be a React component that will render children.</p>"
            }
          ]
        }
      },
    ...
    },
    {
          ...
          Parameter: [
            {
              ...
              field: "listById",
              description:
                "<p>get Object keyed by id of most recent (or highest order) registered objects, filtering out unregistered or banned objects.</p>"
            },
            {
              group: "Parameter",
              type: "Getter",
            ...
            },
            {
              ...
              field: "registered",
              description:
                "<p>get list of all historically registrated objects, even duplicates, ordered by order property of object (defaults to 100).</p>"
            },
            {
              group: "Parameter",
              type: "Getter",
            ...
            },
            {
              ...
              field: "unregistered",
              description:
                "<p>get list of all existing registered objects ids that have been subsequently unregistered.</p>"
            },
            {
              group: "Parameter",
              type: "Getter",
            ...
            },
            {
              ...
              field: "mode",
              description:
                "<p>get current mode (Default Utils.Registry.MODES.HISTORY)</p>"
            },
            {
              group: "Parameter",
              type: "Method",
              ...
              field: "get",
              description:
                "<p><code>reg.get(id,defaultValue)</code> pass the identifier of an object get that object from the registry. Optionally provide a default value if the id doesn't exist in the registry.</p>"
            },
            {
              group: "Parameter",
              type: "Method",
              ...
              field: "isProtected",
              description:
                "<p>pass the identifier of an object to see if it has been protected</p>"
            },
            {
              group: "Parameter",
              type: "Method",
              ...
              field: "isRegistered",
              description:
                "<p>pass the identifier of an object to see if it has been registered</p>"
            },
            {
              group: "Parameter",
              type: "Method",
              ...
              description:
                "<p>pass the identifier of an object to see is NOT registered.</p>"
            },
            {
              group: "Parameter",
              type: "Method",
              ...
              field: "isBanned",
              description:
                "<p>pass the identifier of an object to see if it has been banned</p>"
            },
            {
              group: "Parameter",
              type: "Method",
            ...
            },
            {
              ...
              field: "cleanup",
              description:
                "<p><code>reg.cleanup(id)</code> pass the identifier of an object to be purged from historical registrations (i.e. free up memory) Automatically performed in mode Utils.Registry.CLEAN</p>"
            },
            {
              group: "Parameter",
              type: "Method",
              ...
              field: "protect",
              description:
                "<p><code>reg.protect(id)</code> pass the identifier of an object to protect. Protected objects can not be overridden or cleaned up.</p>"
            },
            {
              group: "Parameter",
              type: "Method",
            ...
            },
            {
              ...
              field: "unprotect",
              description:
                "<p><code>reg.unprotect(id)</code> pass an identifier to unprotect an object</p>"
            },
            {
              group: "Parameter",
              type: "Method",
            ...
            },
            {
              ...
              field: "flush",
              description:
                "<p><code>reg.flush()</code> clear all registrations. Resets registry to newly constructed state.</p>"
            },
            {
              group: "Parameter",
              type: "Method",
              ...
              field: "subscribe",
              description:
                "<p><code>reg.subscribe(cb,id)</code> Adds a callback to indicate changes to the registry. Callback is called on register, unregister, protect, unprotect, ban, cleanup, and flush. Returns unsubscribe function.</p>"
            },
            {
              group: "Parameter",
              type: "Method",
              ...
              field: "unsubscribe",
              description:
                "<p><code>reg.unsubscribe(id)</code> unsubscribe a subscriber by id</p>"
            },
            {
              group: "Parameter",
              type: "Method",
              ...
              description:
                "<p><code>reg.unsubscribeAll()</code> unsubscribe all subscribers to changes made on the registry</p>"
            }
          ],
          register: [
            {
          ...
          subscribe: [
            {
              ...
              field: "cb",
              description:
                "<p>Callback to be invoked on changes to the registry.</p>"
            },
            {
              group: "subscribe",
              type: "String",
              ...
              field: "id",
              description:
                "<p>optional id of the callback, if you want to invoke unsubscribe manually by id, instead of the callback returned from subscribe method</p>"
            }
          ],
          unsubscribe: [
            {
      ...
      version: "0.0.0",
      filename:
        "node_modules/@atomic-reactor/reactium-sdk-core/lib/sdks/utils/registry.js",
      groupTitle: "Reactium"
    },
    {
