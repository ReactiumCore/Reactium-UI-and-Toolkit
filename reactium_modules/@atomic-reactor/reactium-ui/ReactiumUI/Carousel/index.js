...
class Carousel extends Component {
    ...
    next(next, animate = true) {
        ...
        this.animating = true;
        gsap.set(currentSlide, { display: '' });
        gsap.set(nextSlide, { display: '' });
    ...
    prev(next, animate) {
        ...
        gsap.set(currentSlide, { display: '', xPercent: -100 });
        gsap.set(nextSlide, { display: '' });
    ...
    onComplete(evt) {
        ...
        gsap.set(nextSlide, { xPercent: 0, display: '' });
