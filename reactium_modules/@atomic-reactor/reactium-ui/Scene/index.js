...
let Scene = (props, ref) => {
    ...
    const fadeIn = params =>
        new Promise(resolve => {
            ...
            gsap.from(front, animationSpeed, {
                opacity: 0,
    ...
    const fadeOut = params =>
        new Promise(resolve => {
            ...
            gsap.to(front, animationSpeed, {
                opacity: 0,
                ease: Power2.easeInOut,
                onComplete: () => {
                    gsap.set(front, { display: 'none', opacity: 1 });
                    resolve();
                },
            });
        });
    ...
    const flip = params => {
        ...
        return Promise.all([
            new Promise(resolve => {
                ...
                gsap.from(back, animationSpeed, {
                    [prop]: rotation,
                    ease: Power2.easeInOut,
                    onComplete: () => {
                        gsap.set(back, { zIndex: 20 });
                        resolve();
                    },
                });
            }),
            new Promise(resolve => {
                ...
                gsap.to(front, animationSpeed, {
                    ...
                    ease: Power2.easeInOut,
                    onComplete: () => {
                        gsap.set(front, { display: 'none', [prop]: 0 });
                        resolve();
                    },
                });
            }),
